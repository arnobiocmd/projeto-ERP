                    ...
                    <div class="px-2 pt-2">
                        <div class=" mt-2 p-2 radius-4">
                            <div class="rows">
                                ...
                                <div class="col-2 d-flex">
                                    <div class="border radius-4 text-center width-100">
                                        <span class="text-label d-block border-bottom p-1 bg-cinza">Estoque Atual </span>
                                ...
                                <div class="col-2 d-flex">
                                    <div class="border radius-4 text-center width-100">
                                        <span class="text-label d-block border-bottom p-1 bg-cinza">Estoque Real </span>
                ...
                <div class="px-2">
                    <div class="tabela-responsiva pb-4 mt-3">
                        <table cellpadding="0" cellspacing="0" width="100%" id="dataTable">
                            ...
                            <tbody>
                                <?php foreach ($lista as $key => $mov) { ?>
                                 
                                
                                <tr>
                                    <td align="center"><?php echo $mov->id_movimento?></td>
                                    <td align="left"><?php echo date('d/m/Y',strtotime($mov->data_movimento))?></td>
