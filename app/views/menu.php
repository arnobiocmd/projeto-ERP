<div class="col menu-lateral position-relative">
    ...
    <nav class="menuprincipal" id="menu_estoque">
        <ul class="menu-lista">
            ...
            <li><a href="<?php echo URL_BASE."entrada"?>">Entradas</a></li>


            <small><b>Saídas</b></small>
            <li><a href="<?php echo URL_BASE."saida"?>">Saídas</a></li>
            ...
            <li><a href="<?php echo URL_BASE."localizacao"?>">Localizacão</a></li>
            <li><a href="<?php echo URL_BASE."produtolocalizacao"?>">Produto Localizacão</a></li>
            <li><a href="historico_movimento.html">Historico de movimento</a></li>
            <li><a href="extrato_produto.html">Extrado produto</a></li>
            <li><a href="<?php echo URL_BASE."transferencia"?>">Transferencia</a></li>
