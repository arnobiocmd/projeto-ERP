<script src="<?php echo URL_BASE?>assets/js/js_transferencia.js"></script>
<div class="rows mx-0">
                            ...
                            <div class="border p-3 radius-4 pb-4">
                                <div class="rows">
                                    ...
                                    <div class="col-1">
                                        ...
                                        <input type="text" value="1" name="qtde" id="qtde" class="form-campo">
                                    </div>
                                ...
                                <div class="tabela-responsiva pb-4 mt-3">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tbody id="lista_transferencias">
                                           ...
                                           <?php $total = 0; ?>
                                            <?php foreach ($lista as $key => $transferencia) {
                                               $total += $transferencia->subtotal_transferencia; 
                                            ?>
                                            <tr>
                                                <td align="center"><?php echo $transferencia->id_transferencia?></td>
                                                <td align="center"><?php echo date('d-m-Y',strtotime($transferencia->data_transferencia))?></td>
                                            ...
                                            <?php }?>
                                            <tr>
                                                <td align="right" colspan="6"><b>Total:</b> <span class="text-verde minimo-font" id="total_transferencia">R$ <?php echo $total?></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
